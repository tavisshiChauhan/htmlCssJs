...
const text =
  "Hey Buddy, \r\nYour device has been temporarily hacked. \r\nFor the next few moments, I'm interrupting your routine. \n\rSo, get ready for a surprise! \n\rClick on the lower right corner button 😎";
...
$("#play").click(function () {
  ...
  //
  // Set a timeout to stop the "confetti" audio after a specified duration (in milliseconds)
  var confettiDuration = 4000; // Adjust the duration as needed
  setTimeout(function () {
    confetti.pause();
    confetti.currentTime = 0; // Reset the playback to the beginning
  }, confettiDuration);
});
